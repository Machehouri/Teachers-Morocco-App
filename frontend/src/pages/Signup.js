    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <p className="text-xs text-gray-400 mb-6">Join TeachMe Morocco today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* role toggle */}
            <div>
              <label className="block text-xs font-medium text-gray-600 mb-1.5">I want to</label>
              <div className="grid grid-cols-2 gap-2">
                {[
                  { value: "student", label: "Learn", icon: "📚" },
                  { value: "teacher", label: "Teach", icon: "🎓" },
                ].map(opt => (
                  <button
                    key={opt.value}
                    type="button"
